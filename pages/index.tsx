...
const Card: React.FC<CardProps> = ({ href, imgSrc, layoutId }) => {
  return (
    <Link href={href}>
      <div className="relative h-20 md:h-40 bg-gray-300 rounded-xl cursor:pointer hover:bg-gray-50">
...
export default function Home() {
  return (
    <div>
      <h1
      className="text-4xl sm:text-6xl lg:7xl mt-10 md:mt-24 leading-none font-extrabold tracking-tight text-gray-300"
      >
        Construa sites modernos com produtividade sem sair do HTML
      </h1>
